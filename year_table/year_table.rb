...
sections =
  [
   ...
   {src: 1827, dst: 1898, label: "ジョン万次郎(まんじろう)",
     img: "images/John_Manjiro_1921.jpg",
     img_dl: "http://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Nakahama_John_Manjir%C5%8D.jpg/120px-Nakahama_John_Manjir%C5%8D.jpg",
     img_link: "http://commons.wikimedia.org/wiki/Category:Nakahama_Manjir%C5%8D#mediaviewer/File:Nakahama_John_Manjir%C5%8D.jpg",
